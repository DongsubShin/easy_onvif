...
part 'imaging_configuration.g.dart';

///Optional configuration of the image sensor.
@JsonSerializable(explicitToJson: true)
class ImagingConfiguration {
  ...
  factory ImagingConfiguration.fromJson(Map<String, dynamic> json) =>
      _$ImagingConfigurationFromJson(json);

  Map<String, dynamic> toJson() => _$ImagingConfigurationToJson(this);
